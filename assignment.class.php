...
class assignment_turnitin extends assignment_base {
    ...
    function submittedlink() {
        ...
        if (has_capability('mod/assignment:grade', $context)) {
            if (!has_capability('moodle/course:managegroups', $context) and groups_get_user_groups($this->course->id, $USER->id)) {
                $group = groups_get_activity_group($this->cm);
                $count = $this->count_real_submissions($group);  // Only their group
            } else {
